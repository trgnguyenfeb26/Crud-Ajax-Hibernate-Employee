...
<div id="list" class="container mt-4 ">
		<div class="container">
			...
			<div class="container text-left">
				<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"> <span>Thêm Nhân viên</span></a>
			</div>
			<br>
				...
				<tbody>
					<c:forEach var="employee" items="${listEmployee}">
						...
						<tr>
							...
							<td>	
								<a class="btn btn-danger" onclick = "deleteEmployee( ${employee.getId()})">Xóa</a>	
								<a href="#editEmployeeModal" data-toggle="modal" type="button" class="btn btn-warning editbtn"> Hiệu chỉnh </a>
								</td>
